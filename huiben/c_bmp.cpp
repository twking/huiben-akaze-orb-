...
{  
	...
	{  
		...
		//printf("sizeof(ClBitMapFileHeader)=%d\n",sizeof(ClBitMapFileHeader)); 
		...
		*/
		//printf("sizeof(ClBitMapInfoHeader)=%d\n",sizeof(ClBitMapInfoHeader));
...
{  
	...
	{  
		step = (bmpImg->channels*bmpImg->width+3)/4*4;  
	...
	{  
		step = (bmpImg->width+3)/4*4;  
		bmpFileHeader.bfSize = 54 + 256*4 + bmpImg->width*bmpImg->height;  
		bmpFileHeader.bfReserved1 = 0;  
		bmpFileHeader.bfReserved2 = 0;  
